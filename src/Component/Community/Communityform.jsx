...
export default function Communityform() {
  ...
  const faqData = [
    {
      question: "What is the best way to prevent common illnesses like colds and flu?",
      answer: "The best way to prevent common illnesses is by practicing good hygiene, such as washing hands frequently, avoiding close contact with sick individuals, staying hydrated, and getting a flu vaccine annually."
    },
    { question: "How often should I go for a routine check-up?", answer: "" },
    { question: "What should I do if I experience symptoms of COVID-19?", answer: "" },
    { question: "How can I manage chronic conditions like diabetes or hypertension?", answer: "" },
    { question: "What are the benefits of getting vaccinated?", answer: "" },
  ];

  return (
    <div className="max-w-2xl mx-auto mt-8 p-6 border border-gray-200 rounded-lg">
