...
import "../../App.css";
import PostTypeModal from "./Posttype";
...
const menuItems = [
  ...
  { icon: Grip, label: "My Properties", section: "properties" },
...
export function DashboardSidebar({ isOpen, toggleSidebar }) {
  ...
  const handleSectionClick = (section) => {
    ...
    if (section === "services") {
      ...
      navigate(`/propertyownerdashboard/${section}`);
    }
    if (isMobile && isOpen) {
      toggleSidebar();
    }
    ...
    <>
      ...
      >
        <SidebarContent className="h-full flex flex-col">
          ...
          <div className="px-2 hover:bg-gray-100">
            <Link to="/">
