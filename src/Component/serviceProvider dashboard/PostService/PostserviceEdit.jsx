  ...
  return (
    <div className="bg-gray-100 min-h-screen  p-6">
      ...
      <div>
       ...
       <h1 onClick={closeForm} > <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
