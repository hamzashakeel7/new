...
import "../../App.css";
import PostTypeModal from "../serviceProvider dashboard/Posttype"; // Import the PostTypeModal

const menuItems = [
  { icon: Home, label: "My Profile", section: "My profile" },
  {
    icon: BaggageClaim,
    label: "Post a Service or Property",
    section: "services",
  },
...
export function DashboardSidebar({ isOpen, toggleSidebar }) {
  ...
  const handleSectionClick = (section) => {
    ...
    if (section === "services") {
      ...
      navigate(`/servicedashboard/${section}`);
    }
    if (isMobile && isOpen) {
      toggleSidebar();
    }
