    ...
    <table className="table-auto w-full text-left border-collapse">
      <thead>
        <tr className="border-b">
          {["Service Name", "Service Type", "Provider", "Price", "Actions"].map((header, idx) => (
            <th key={idx} className="p-4">
              <div className="flex items-center justify-between">
                <span>{header}</span>
                <svg width="5" height="20" viewBox="0 0 5 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2">
                  <circle cx="2.19095" cy="2.61807" r="2.19095" fill="#949494"/>
                  <circle cx="2.19095" cy="9.99997" r="2.19095" fill="#949494"/>
                  <circle cx="2.19095" cy="17.3819" r="2.19095" fill="#949494"/>
                </svg>
              </div>
            </th>
          ))}
...
<div className="mt-12 overflow-x-auto bg-white shadow-lg rounded-lg p-6">
  <h2 className="text-2xl flex font-bold mb-4 items-center">
    ...
    My Properties
    <svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2">
      ...
      {[...Array(2)].map((_, i) => (
        <tr key={i} className="border-b">
          ...
          <button className="text-blue-600 flex items-center space-x-2 text-sm">
                ...
                <button className="text-red-600 flex items-center space-x-2 text-sm">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.5599 5.3L11.5599 12.14C11.5599 12.7696 11.0495 13.28 10.4199 13.28L3.57994 13.28C2.95034 13.28 2.43994 12.7696 2.43994 12.14L2.43994 5.3" stroke="#565D6D" stroke-width="1.368" stroke-miterlimit="10" stroke-linecap="round"/>
<path d="M0.72998 3L13.27 3" stroke="#565D6D" stroke-width="1.368" stroke-miterlimit="10" stroke-linecap="square"/>
