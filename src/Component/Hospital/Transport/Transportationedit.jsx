...
const Transportationedit = () => {
  return (
    <div className="bg-white h-screen w-full flex justify-center items-center">
      <div
        className="bg-white w-full max-w-[80vw] rounded-lg p-6 "
        style={{ maxHeight: "90vh" }}
      >
        {/* Modal Header */}
        <div className="bg-white flex justify-between items-center border-b pb-2 mb-4">
        ...
        <div className="bg-white overflow-y-auto" style={{ maxHeight: "80vh" }}>
          ...
          {/* Action Buttons */}
          <button className="bg-purple-700 h-10 w-full mt-4 text-white">
            Save
          </button>
        </div>
      </div>
