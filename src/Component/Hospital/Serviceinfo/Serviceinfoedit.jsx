...
const ServiceInfoedit = () => {
  ...
  return (
    <div className="p-6 w-full md:w-[85vw] lg:w-[80vw] max-h-[90vh]">
      <div className="bg-white rounded-lg p-6 w-full md:w-[80vw] lg:w-[72vw] max-h-[90vh]  ">
        {/* Close Button */}
        <button
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[...Array(3)].map((_, idx) => (
              <div key={idx} className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
