    ...
    <div className="flex items-center justify-center lg:flex-row flex-col-reverse w-full ">
      <div className="lg:h-[760px] object-cover flex items-center justify-center">
        <img
          src={hero}
          alt="heroimage"
          className="lg:w-[1300px] lg:h-[760px] w-[450px] h-1/2 object-cover object-top"
        />
      </div>
      <div className="w-full lg:w-1/2 bg-gradient-to-t from-purple-800 to-purple-700 flex items-end justify-end flex-col lg:h-[760px] ">
        <div className="flex items-end justify-end flex-col gap-3 lg:gap-5 relative lg:top-[20rem] p-5 lg:p-10 lg:w-[45rem]">
          ...
          <p className="text-gray-100 text-lg lg:text-xl text-center w-full md:w-[32rem] lg:w-[40rem]">
        ...
        <div className=" flex items-center justify-center mx-auto lg:mx-0 lg:relative">
          <img
            src={herohand}
            alt="hands"
